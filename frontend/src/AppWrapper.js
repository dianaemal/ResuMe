...
export default function AppWrapper() {
  ...
  const paths = ['/login', '/register', '/logout', '/password-forget' ];
  const headerRoutes = !(paths.includes(location.pathname) || location.pathname.startsWith('/password-reset-confirm'));
